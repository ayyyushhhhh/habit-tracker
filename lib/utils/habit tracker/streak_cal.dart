...
Habit calculateStreak({
  ...
  final int diff = DateTime.now().difference(habit.dateCreated!).inDays;
  ...
  final List<DateTime> totalDates = habit.completedDates! + habit.skipDates!;
  totalDates.sort();

  if (totalDates.isNotEmpty && habit.skipDates!.contains(totalDates.last)) {
    streaks = 0;
  } else {
